...
4. Activar el entorno de python
    ...
    ```
5. Moverse a la carpeta de la práctica y ya se puede ejcutar [main_regresion.py](./main_regresion.py) y [main_classification.py](./main_regresion.py)
    ```sh
    cd iage_prac_5
    ```
    ```sh
    python main_regresion_2.py
    ```
    ```sh
